...
type PestProposal struct {
	Pest string `form:"Pest" json:"Pest"  binding:"required,min=1"` // 必填、对于商品id,表示它的数字>=1
}

func (a PestProposal) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		(&web.AI{}).PestProposal(extraAddBindDataContext)
	}
}
