...
type AEProposalAI struct {
	AEID int32 `form:"AEID" json:"AEID"  binding:"required,min=0"` // 必填、对于商品id,表示它的数字>=1
}

func (a AEProposalAI) CheckParams(context *gin.Context) {
	...
	if extraAddBindDataContext == nil {
		...
		(&web.AI{}).AEProposalAI(extraAddBindDataContext)
	}
}
