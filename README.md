...
CloudAgri 面向现代化农业需求，提供从设备数据采集、环境监测到 AI 智能决策的全链路解决方案。支持多端访问（PC Web + 移动端 App）。
...
| 主页面 | 种植环境监测 |
|--------|-------------|
| ![主页面](云端田园界面/PC端/主页面.png) | ![种植环境监测](云端田园界面/PC端/种植环境监测.png) |

| 粮仓环境监测 | 设备管理 |
|-------------|---------|
| ![粮仓环境监测](云端田园界面/PC端/粮仓环境监测.png) | ![设备管理](云端田园界面/PC端/设备管理.png) |

| AI 农业专家 | AI 监控 |
|-----------|--------|
| ![AI农业专家](云端田园界面/PC端/AI农业专家.png) | ![AI监控](云端田园界面/PC端/AI监控.jpg) |

| 产量预测 | 作物推荐 |
|---------|---------|
| ![产量预测](云端田园界面/PC端/产量预测.png) | ![作物推荐界面](云端田园界面/PC端/作物推荐界面.png) |

| 超级管理面板 | 登录界面 |
|------------|---------|
| ![超级管理面板](云端田园界面/PC端/超级管理面板.png) | ![登录界面](云端田园界面/PC端/登录界面.png) |

### 移动端

| 种植环境监测 | 粮仓环境监测 |
|-------------|-------------|
| ![种植环境监测](云端田园界面/移动端/种植环境监测.png) | ![粮仓环境监测](云端田园界面/移动端/粮仓环境监测.png) |

| 设备管理 | AI 农业专家 |
|---------|------------|
| ![设备管理](云端田园界面/移动端/设备管理.png) | ![AI农业专家](云端田园界面/移动端/AI农业专家.png) |

| 超级管理界面 | 登录界面 |
|------------|---------|
| ![超级管理界面](云端田园界面/移动端/超级管理界面.png) | ![登录界面](云端田园界面/移动端/登录界面.png) |
...
│   ├── pages/                # 页面源码
│   │   ├── index/            # 种植环境监测
│   │   ├── Monitoring_Points/# 粮仓环境监测
│   │   ├── GPT/              # AI 农业专家
│   │   ├── AI_Surveillance/  # AI 监控
│   │   ├── Settings/         # 系统设置 & 超级管理
│   │   └── login/            # 登录模块
│   ├── static/               # 静态资源
│   ├── store/                # Vuex 状态管理
...
cd uniapp
npm install
# 使用 HBuilderX 打开项目，运行到微信小程序/H5/App
```
